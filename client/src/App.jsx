...
function App() {
  ...
  useEffect(() => {
    // Зміна класу body для глобальної теми
  ...
  // --- МАТЕМАТИКА (Рахуємо баланс ТУТ, перед return) ---
  // Використовуємо (accounts || []) щоб не впало, якщо accounts ще немає
  ...
  return (
    <div className="dashboard">
      ...
      {/* 🔥 ЗАГАЛЬНІ КОШТИ (З "розумним" кольором) 🔥 */}
      <div
      ...
      >
        ...
        <div
          ...
          // Якщо менше 0 — червоний (#f44336), інакше — зелений (#4caf50)
          style={{ color: Number(totalBalance) < 0 ? "#f44336" : "#4caf50" }}
        >
          {totalBalance} <small>UAH</small>
        </div>
      </div>

      {/* Рахунки в окремому контейнері */}
      <div
